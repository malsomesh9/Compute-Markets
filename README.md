...
Live demo: https://vxq35sgz.insforge.site. API readiness: https://vericompute-api-83d03433-e874-48a0-92b9-fa7602125977.fly.dev/ready. Release gates: https://vericompute-api-83d03433-e874-48a0-92b9-fa7602125977.fly.dev/v1/release/readiness. Program: `HsjKrSHNqXgqkDmyp1PAhhFAa16GHfeRNZ9s6Zuqpfyd` on Solana devnet. The market only shows signed, indexed supply; it can be empty when no independent provider is online.
